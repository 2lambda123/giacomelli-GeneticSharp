...
public partial class MainPage : ContentPage {
  ...
  public MainPage(MainViewModel vm) {
    ...
    _sampleController =
        TypeHelper.CreateInstanceByName<ISampleController>("TSP");
  ...
  void ResetSampleContext() {
    _sampleContext.DrawingArea = new System.Drawing.Rectangle(
        (int)canvas.X, (int)canvas.Y, (int)canvas.Width, (int)canvas.Height);
    ResetSample();
  }
  ...
  public void StartGA() {
    RunGA(() => {
      ...
      _sampleContext.Population = new Population(
          ...
          _sampleController.CreateChromosome()) { GenerationStrategy =
                                                      _vm.GenerationStrategy };

      _ga = new GeneticAlgorithm(_sampleContext.Population, _vm.Fitness,
                                 _vm.Selection, _vm.Crossover, _vm.Mutation) {
        // CrossoverProbability =
        // Convert.ToSingle(hslCrossoverProbability.Value), MutationProbability
        // = Convert.ToSingle(hslMutationProbability.Value),
        Reinsertion = _vm.Reinsertion, Termination = _vm.Termination
      };

      _sampleContext.GA = _ga;
      _ga.GenerationRan += delegate { _sampleController.Update(); };
  ...
  private void RunGAButton_Clicked(object sender, EventArgs e) { StartGA(); }
}
}
