...
public class SampleContext {
  ...
  //     color='gray'>{0}</span>".With(string.Format(CultureInfo.InvariantCulture,
  //     text, args))); Buffer.DrawLayout(GC, 0, _lastTextY, Layout); _lastTextY
  //     += 20;
  // }
  ...
  //     gc.SetLineAttributes(1, LineStyle.OnOffDash, CapStyle.Projecting,
  //     JoinStyle.Round);
